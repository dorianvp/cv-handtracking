...
def main():
    ...
    # hand_landmark_drawing_spec = mp_drawing.DrawingSpec(thickness=1, circle_radius=1)
    hand_connection_drawing_spec = mp_drawing.DrawingSpec(thickness=3, circle_radius=10, color=(100, 255, 100))
